                ...
                <div class="form-holder">
                    <div class="form-content">
                        <div class="form-items">
                            <h3>Simple Registeration</h3>
                            <form class="requires-validation" action="{{url('store')}}" method="post" novalidate>
                                @csrf
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <input class="form-control" type="text" name="college" placeholder="College Name" required>
