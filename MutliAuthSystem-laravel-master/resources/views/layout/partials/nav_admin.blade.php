                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							{{-- All Problems start here --}}
							<li class="submenu">
								<a href="#"><i class="fe fe-document"></i> <span> All Problems</span> <span class="menu-arrow"></span></a>
								
								<ul style="display: none;">
									{{-- Crud Type start here --}}
									<li class="submenu">
										<a href="#"><i class="fe fe-document"></i> <span> Crud Type</span> <span class="menu-arrow"></span></a>
										<ul style="display: none;">
											<li><a href="{{url('admin/simple-index')}}">Simple Crud</a></li>
											<li><a href="{{url('admin/ajax-index')}}">Crud + Ajax</a></li>
											<li><a href="#">Inline Crud</a></li>

										</ul>
									</li>
									{{-- Crud Type close here --}}
									
									{{-- Rating system start here --}}
									<li class="submenu">
										<a href="#"><i class="fe fe-document"></i> <span> Rating System</span> <span class="menu-arrow"></span></a>
										<ul style="display: none;">
											<li><a href="#">Rating Simple</a></li>
											<li><a href="#">Rating Ajax</a></li>
										</ul>
									</li>
									{{-- Rating system close here --}}

									{{-- Pyament system start here --}}
									<li class="submenu">
										<a href="#"><i class="fe fe-document"></i> <span> Pyament System</span> <span class="menu-arrow"></span></a>
										<ul style="display: none;">
											<li><a href="#">Paypal Pyament</a></li>
											<li><a href="#">PayUmony Pyament</a></li>
										</ul>
									</li>
									{{-- Pyament system close here --}}
 
									{{-- Download system start here --}}
									<li class="submenu">
										<a href="#"><i class="fe fe-document"></i> <span>DownloadSystem</span> <span class="menu-arrow"></span></a>
										<ul style="display: none;">
									...
									{{-- Download system close here --}}

								</ul>
								
							</li>
							{{-- All Problems close here --}}
